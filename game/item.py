...
def addItem(itemObjs,time,blankTileSet,displaysurf):
    for i in range(0,random.randint(1,3)):
        tilePosition = blankTileSet.pop()
        itemObjs.append(item(time,tilePosition,displaysurf,random.randint(0,1)))
...
class item:
    ...
    def __init__(self,time,tilePosition,displaysurf,item_num):
       
        randomBlankTile = tilePosition
    ...
    def checkCollidePlayerAndEvent(self, player, obj):
